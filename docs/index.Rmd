...
citation_url: https://Ljwook92.github.io/distill
...
To create an [R Markdown](https://rmarkdown.rstudio.com) document that uses the Distill format, first install the development version of the **distill** R package from GitHub:
